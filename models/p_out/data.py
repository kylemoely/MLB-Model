...
def preprocess_data(df):
    features = ["launch_angle","launch_speed","total_distance","hit_location","first_base_runner", "second_base_runner", "third_base_runner"]
    target = "in_play_out"
    ...
    train_data = lgb.Dataset(X_train, label=y_train, categorical_feature=["hit_location"])
    test_data = lgb.Dataset(X_test, label=y_test, categorical_feature=["hit_location"])
